...
class TrackingEnv(MultiAgentEnv):
    ...
    def render(self):
        ...
        pio.write_image(fig1, '/project/multi_agent_critic_gnn_threshold/results/probability_of_detection.pdf')
        ...
        pio.write_image(fig2, '/project/multi_agent_critic_gnn_threshold/results/waveform_duration_ratio.pdf')
        ...
        # Save the second plot to a file
        pio.write_image(fig3, '/project/multi_agent_critic_gnn_threshold/results/firm_track_prob.pdf')
    ...
    def render_hist_treshold(self, pds, ratios, track_probs, treshold=0.9):
            ...
            # Save the first plot to a file
            pio.write_image(fig1, '/project/multi_agent_critic_gnn_threshold/results/probability_of_detection_filtered.pdf')
            ...
            # Save the second plot to a file
            pio.write_image(fig3, '/project/multi_agent_critic_gnn_threshold/results/firm_track_prob_filtered.pdf')