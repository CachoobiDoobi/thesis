...
cdir = "/nas-tmp/Radu/cc_gnn_threshold/results/multiagent_cc_gnn_threshold/CentralizedCritic_TrackingEnv_7b971_00000_0_2024-05-02_10-19-38/checkpoint_000000"
...
np.savetxt("/project/multi_agent_critic_gnn_threshold/results/pds.txt", pds)
np.savetxt("/project/multi_agent_critic_gnn_threshold/results/ratios.txt", ratios)
np.savetxt("/project/multi_agent_critic_gnn_threshold/results/track.txt", track)
