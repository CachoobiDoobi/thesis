...
cdir = '/nas-tmp/Radu/cc_fc/results/multiagent_cc_fc/CentralizedCritic_TrackingEnv_9e8eb_00000_0_2024-05-14_10-13-33/checkpoint_000000'
...
np.savetxt("/project/multi_agent_critic_fc/results/pds.txt", pds)
np.savetxt("/project/multi_agent_critic_fc/results/ratios.txt", ratios)
np.savetxt("/project/multi_agent_critic_fc/results/track.txt", track)
